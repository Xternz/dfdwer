                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          buildImageButton(domain_url+set1[currentQuestionIndex]['scenario_image'], set1[currentQuestionIndex]['scenario_label']),
                          buildImageButton(domain_url+set2[currentQuestionIndex]['scenario_image'], set2[currentQuestionIndex]['scenario_label']),
                          buildImageButton(domain_url+set3[currentQuestionIndex]['scenario_image'], set3[currentQuestionIndex]['scenario_label']),
                        ],
                      ),
